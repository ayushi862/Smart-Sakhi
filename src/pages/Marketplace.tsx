...
const STATIC_PRODUCTS: StaticProduct[] = [
  ...
  { id:"f9",  title:"Rasgulla (12 pcs)",             description:"Soft spongy rasgulla in sugar syrup, homemade",        price:180, category:"sweets",   image_url:"https://www.vegrecipesofindia.com/wp-content/uploads/2021/07/rasgulla-recipe-1.jpg",                state:"West Bengal", city:"Kolkata",   rating:5.0 },
  ...
  { id:"f12", title:"Mathri & Namkeen Pack",         description:"Crispy mathri with assorted namkeen, 400g",            price:150, category:"snacks",   image_url:"https://www.vegrecipesofindia.com/wp-content/uploads/2020/10/mathri-recipe-1.jpg",                state:"Delhi",       city:"Delhi",     rating:4.6 },
  ...
  { id:"f21", title:"Learn Rajasthani Cooking",      description:"Dal baati, gatte ki sabzi, churma — 3hr class",       price:500, category:"cooking_class", image_url:"https://images.pexels.com/photos/3184183/pexels-photo-3184183.jpeg?auto=compress&cs=tinysrgb&w=400", state:"Rajasthan", city:"Udaipur", rating:4.9 },
  { id:"f22", title:"Bengali Sweets Masterclass",    description:"Rasgulla, sandesh, mishti doi — 4hr workshop",        price:600, category:"cooking_class", image_url:"https://images.pexels.com/photos/3184192/pexels-photo-3184192.jpeg?auto=compress&cs=tinysrgb&w=400", state:"West Bengal", city:"Kolkata", rating:5.0 },
  ...
  { id:"f27", title:"Homemade Ghee (Pure Desi)",     description:"A2 cow milk ghee, bilona method, 500ml",             price:450, category:"homemade", image_url:"https://images.pexels.com/photos/4198019/pexels-photo-4198019.jpeg?auto=compress&cs=tinysrgb&w=400",  state:"Gujarat",     city:"Anand",     rating:5.0 },
  { id:"f28", title:"Organic Jaggery (Gur)",         description:"Pure sugarcane jaggery, no chemicals, 1kg",          price:120, category:"homemade", image_url:"https://images.pexels.com/photos/4198019/pexels-photo-4198019.jpeg?auto=compress&cs=tinysrgb&w=400",  state:"Maharashtra", city:"Kolhapur",  rating:4.8 },
];
